...
<form id="login-form" method="post" action="<?php echo site_url(array("log","in")) ?>" role="form">
     <div id="error" class="alert alert-danger">Email o contraseña invalidos</div>
                    ...
                    <form>
                        ...
                        <div class="textbox-wrap">
                            <div class="input-group">
                                ...
                                <input required="required" name="password" class="form-control " placeholder="Password" type="password">
                            </div>
                        </div>
