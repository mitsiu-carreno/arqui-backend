...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        //echo is_writable("./videos/") ? "si":"no";
        $this->options = array(
            'script_url' => $this->get_full_url().'/uploads.php',
            'upload_dir' => "./videos/",
//            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/videos/',
            'upload_url' => $this->get_full_url().'/videos/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
